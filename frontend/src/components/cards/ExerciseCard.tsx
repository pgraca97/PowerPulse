...
export function ExerciseCard({
  ...
  const [processingExercise, setProcessingExercise] = useState<string | null>(
    null
  );
  ...
  const filteredExercises = React.useMemo(() => {
    ...
    return exercises.filter((exercise) => {
      ...
      const matchesMuscle =
        !filters.muscle || exercise.muscles.includes(filters.muscle);
      const matchesType =
        !filters.type ||
        exercise.type.title.toLowerCase() === filters.type.toLowerCase();
